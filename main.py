...
def selfbot_menu(bot):
    ...
    print(f"""{y}-----------------------------------------------------------------------------------------------------------------------
{b}|{w} https://github.com/24Polo {b}|{w} https://github.com/24Polo {b}|{w} https://github.com/24Polo {b}|{w} https://github.com/24Polo
{y}------------------------------------------------------------------------------------------------------------------------\n""")
...
async def help(ctx):
    ...
    help_text = f"""
**Aura SelfBot | Prefix: `{prefix}`**\n
**Commands:**\n
> :space_invader: `{prefix}crwvs` - Show my social networks.
...
async def astraa(ctx):
    ...
    > :pager: `Discord Server`\n*https://discord.gg/u6SH3MKe*
    > :computer: `GitHub Page`\n*https://github.com/24Polo*"""
...
async def qr(ctx, *, text: str="https://discord.gg/u6SH3MKe"):
    qr = qrcode.make(text)
...
@bot.command()
async def spam(ctx, amount: int=1, *, message_to_send: str="https://discord.gg/u6SH3MKe"):
    await ctx.message.delete()
...
@bot.command()
async def sendall(ctx, *, message="https://discord.gg/u6SH3MKe"):
    await ctx.message.delete()
